...
const messages: Messages = {
  fr: {
    ...
    'workspace.editAnalysis': "Modifier l'analyse",
    'workspace.inspectAnalysis': "Voir l'analyse",
    'workspace.analysisEditingUnavailable': 'Lancez une analyse avant de la modifier',
    'analysisEditor.title': "Editeur d'analyse",
    'analysisEditor.unsaved': 'Modifications non enregistrées',
    'analysisEditor.preview': 'Prévisualiser',
    'analysisEditor.previewing': 'Prévisualisation…',
    'analysisEditor.discard': 'Annuler les modifications',
    'analysisEditor.save': 'Enregistrer',
    'analysisEditor.saving': 'Enregistrement…',
    'analysisEditor.loading': "Chargement de l'éditeur…",
    'analysisEditor.readingOrder': 'Ordre de lecture',
    'analysisEditor.collapseAll': 'Tout replier',
    'analysisEditor.expandAll': 'Tout déplier',
    'analysisEditor.pdfLayout': 'Mise en page PDF',
    'analysisEditor.markdown': 'Markdown',
    'analysisEditor.chunksStale': 'Les chunks proviennent d’une analyse plus ancienne. Régénérez-les avant ingestion.',
    'analysisEditor.noPages': 'Aucune projection de page disponible.',
    'analysisEditor.selectElement': 'Sélectionnez un élément modifiable.',
    'analysisEditor.text': 'Texte',
    'analysisEditor.headingLevel': 'Niveau de titre',
    'analysisEditor.bodyText': 'Texte',
    'analysisEditor.deleteElement': 'Supprimer l\'élément',
    'analysisEditor.titleText': 'Titre',
    'analysisEditor.reorder': 'Réordonner',
    'analysisEditor.mergeSelected': 'Fusionner {n} sélectionnés',
    'analysisEditor.history': 'Historique ({n})',
    'analysisEditor.historyEmpty': 'Aucune modification enregistrée.',
  ...
  en: {
    ...
    'workspace.editAnalysis': 'Edit analysis',
    'workspace.inspectAnalysis': 'Inspect analysis',
    'workspace.analysisEditingUnavailable': 'Run an analysis before editing it',
    'analysisEditor.title': 'Analysis editor',
    'analysisEditor.unsaved': 'Unsaved changes',
    'analysisEditor.preview': 'Preview',
    'analysisEditor.previewing': 'Previewing…',
    'analysisEditor.discard': 'Discard changes',
    'analysisEditor.save': 'Save',
    'analysisEditor.saving': 'Saving…',
    'analysisEditor.loading': 'Loading editor…',
    'analysisEditor.readingOrder': 'Reading order',
    'analysisEditor.collapseAll': 'Collapse all',
    'analysisEditor.expandAll': 'Expand all',
    'analysisEditor.pdfLayout': 'PDF layout',
    'analysisEditor.markdown': 'Markdown',
    'analysisEditor.chunksStale': 'Chunks are based on an older analysis. Regenerate them before ingesting.',
    'analysisEditor.noPages': 'No page projection available.',
    'analysisEditor.selectElement': 'Select an editable element.',
    'analysisEditor.text': 'Text',
    'analysisEditor.headingLevel': 'Heading level',
    'analysisEditor.bodyText': 'Body text',
    'analysisEditor.deleteElement': 'Delete element',
    'analysisEditor.titleText': 'Title',
    'analysisEditor.reorder': 'Reorder',
    'analysisEditor.mergeSelected': 'Merge {n} selected',
    'analysisEditor.history': 'History ({n})',
    'analysisEditor.historyEmpty': 'No saved changes yet.',
